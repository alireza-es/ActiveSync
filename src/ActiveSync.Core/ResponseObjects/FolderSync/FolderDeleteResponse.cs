...
{
    public class FolderDeleteResponse : ASResponse
    {
        public string SyncKey { get; set; }
        public eFolderDeleteStatus Status { get; set; }
        ...
        public override string GetAsXML()
        {
            ...
            var rootNode = xmlDocument.AppendContainerNode(FolderHierarchyStrings.FolderDelete, Namespaces.FolderHierarchy);
